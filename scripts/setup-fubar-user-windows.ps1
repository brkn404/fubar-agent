...
Write-ColorOutput "   $HomeDir\venv\Scripts\pip.exe install -e C:\ProgramData\fubar-agent" "Yellow"
Write-ColorOutput "   (If you cloned to a different location, use that path instead)" "Yellow"
Write-Host ""
